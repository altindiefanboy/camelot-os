...
/**
 * @brief Returns pointer to implementation-defined string corresponding to
 * error n.
 *
...
/**
 * @brief Truncates string into tokens broken at delimiter characters found in
 * string ct.
 *
 * @param s String to truncate, or NULL.
 * @param ct String containing delimiter characters.
 *
 * @return String s truncated at first occurrence of any delimiter character
 * found in string ct.
 *
 * @note If argument s is a NULL pointer, the pointer returned points to the
 * next token from the string used in the last non-NULL call. The string ct
 * may be different on each call. Returns NULL if no further token was found.
 */
